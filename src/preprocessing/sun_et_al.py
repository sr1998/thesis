...
def preprocess_data(do_prevalence_and_abundance_filtering: bool, normalize_and_transform: bool, title_addition: str, tax_level: str = "species") -> None:
    ...
    sample_group.to_csv(f"{data_root_dir}/sample_group_{tax_level}_{title_addition}.csv")


if __name__ == "__main__":
    preprocess_data(do_prevalence_and_abundance_filtering=False, normalize_and_transform=True, title_addition="only_normalized_and_transformed", tax_level="species")