...
class MGnifyData:
    ...
    def filter_download_links_for_most_recent_link(self, links: Dict[str, List[str]]) -> Dict[str, list[str]]:    # TODO make pipeline version a parameter too
        ...
        with requests_session() as session:
            ...
            for primary_accession in primary_study_accessions:
                if primary_accession not in sec_accessions:
                    ...
                    sec_accessions[primary_accession] = study["data"]["attributes"]["secondary-accession"]
        ...
        with requests_session() as session:
            ...
            for secondary_accession in secondary_study_accessions:
                if secondary_accession not in primary_accessions:                    
                    ...
                    primary_accessions[secondary_accession] = study["data"]["id"]
